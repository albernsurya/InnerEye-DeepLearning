...
class LabelDistribution(object):
    ...
    def add_noise_to_distribution(self, offset: float, distribution: np.ndarray, noise_model_type: str) -> np.ndarray:
        from DataQuality.datasets.label_noise_model import get_cifar10_asym_noise_model
        from DataQuality.datasets.label_noise_model import get_cifar10_sym_noise_model
