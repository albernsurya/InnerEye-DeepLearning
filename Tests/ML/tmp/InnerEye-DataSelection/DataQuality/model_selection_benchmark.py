...
from DataQuality.datasets.cifar10 import get_cifar10_label_names
from DataQuality.deep_learning.model_inference import inference_ensemble
from DataQuality.deep_learning.utils import create_logger, load_model_config, load_selector_config
from DataQuality.selection.selectors.label_based import cross_entropy
from DataQuality.selection.simulation import DataCurationSimulator
from DataQuality.selection.simulation_statistics import get_ambiguous_sample_ids
from DataQuality.utils.dataset_utils import get_datasets
from DataQuality.utils.default_paths import BENCHMARK2_DIR, BENCHMARK3_DIR, FIGURE_DIR
from DataQuality.utils.generic import create_folder
from DataQuality.utils.plot import plot_confusion_matrix
...
def main(args: argparse.Namespace) -> None:
    ...
    for cfg_path in args.curated_label_config if args.curated_label_config else list():
        ...
        search_dir = BENCHMARK2_DIR / cfg.selector.output_directory
        targets_list = list()
...
if __name__ == '__main__':
    ...
    create_folder(BENCHMARK3_DIR)
    create_logger(BENCHMARK3_DIR)
    main(args)
