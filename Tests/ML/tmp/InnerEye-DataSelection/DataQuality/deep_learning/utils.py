...
from DataQuality.configs import model_config
from DataQuality.configs.selector_config import get_default_selector_config
from DataQuality.deep_learning.self_supervised.configs import ssl_model_config
from DataQuality.deep_learning.self_supervised.utils import create_ssl_image_classifier

from DataQuality.utils.default_paths import PROJECT_ROOT_DIR, get_train_output_dir
from DataQuality.utils.generic import setup_cudnn
    ...
    if config.train.use_self_supervision:
        ...
        try:
            ...
            module = import_module(
                f'DataQuality.deep_learning.architectures.{config.model.type}.{config.model.name}')
